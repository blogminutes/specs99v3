...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full flex-col gap-[min(10vh,10vw)] py-[min(4vh,4vw)]">
        {/* HERO SECTION */}
        <div className="mx-auto grid w-[100%] grid-cols-[1fr_9fr_1fr] overflow-hidden shadow-primary-sm max-[600px]:grid-cols-1">
